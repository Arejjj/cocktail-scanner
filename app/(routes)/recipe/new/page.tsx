...
export default function NewRecipePage() {
  ...
  function save() {
    ...
    addCocktail({
      id, name, category, glass, garnish, instructions, ingredients,
      imageUrl: imageUrl || undefined,
      tags: [], source: "manual", createdAt: new Date().toISOString(),
    });
      ...
      <div className="px-5 flex flex-col gap-7">
        ...
        <div className="flex gap-4">
          <Field label="Category" className="flex-1">
            <TextInput value={category} onChange={setCategory} placeholder="e.g. Sour" />
          </Field>
          <Field label="Glassware" className="flex-1">
            <TextInput value={glass} onChange={setGlass} placeholder="e.g. Coupe" />
          </Field>
        </div>

        {/* Garnish */}
        <Field label="Garnish">
          <TextInput value={garnish} onChange={setGarnish} placeholder="e.g. Lemon Twist" />
        </Field>
